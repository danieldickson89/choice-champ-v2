...
const QuickEditRow = ({
    ...
    return (
        <div className='quick-edit-row'>
            <div className='quick-edit-row-top'>
                {item.poster && (
            ...
            <div className='quick-edit-controls'>
                <ToggleButton
                    ...
                    aria-label={`Toggle personal ${watchedLabel.toLowerCase()} for ${item.title}`}
                />
                <ToggleButton
                    active={isGroup}
                    label='Group'
                    ...
                    aria-label={`Toggle group complete for ${item.title}`}
                />
                <button
                    type='button'
...
const ToggleButton = ({ active, label, color, onClick, ...rest }) => (
    <button
        type='button'
        role='switch'
        aria-checked={active}
